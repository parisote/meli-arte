    ...
    this.innerHTML = `
      ...
      <p class="card-text">${this.subheading}</p>
        ...
        <div class="btn-group-vertical btn-group-sm" role="group" aria-label="Basic outlined example">
          <button type="button" class="btn btn-outline-primary"><i class="tiny material-icons">keyboard_arrow_up</i></button>
          <button type="button" class="btn btn-outline-primary">2</button>
          <button type="button" class="btn btn-outline-primary"><i class="tiny material-icons">keyboard_arrow_down</i></button>
        </div>
      </div>
      </div>
      </div>
